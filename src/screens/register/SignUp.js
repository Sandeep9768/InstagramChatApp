...
import { auth, createUserWithEmailAndPassword, storage, storageRef, uploadBytesResumable, getDownloadURL, database, databaseRef, databaseSet, databaseGet, databaseChild } from "../../../firebase";
...
const SignUp = ({navigation}) => {
  ...
  const createCometChatAccount = async ({ id, fullname, avatar }) => {
    try {
      ...
      if (cometChatUser && authenticatedUser.id) {
